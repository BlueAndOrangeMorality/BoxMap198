...
//
	...
	public void movePlayer () {
		if (Gdx.input.isKeyPressed(Keys.A)) body.applyLinearImpulse(new Vector2(-1.2f, 0), body.getPosition(), true);
		if (Gdx.input.isKeyPressed(Keys.D)) body.applyLinearImpulse(new Vector2(1.2f, 0), body.getPosition(), true);
		if (Gdx.input.isKeyPressed(Keys.W)) body.applyLinearImpulse(new Vector2(0, 1.2f), body.getPosition(), true);
		if (Gdx.input.isKeyPressed(Keys.S)) body.applyLinearImpulse(new Vector2(0, -1.2f), body.getPosition(), true);
	}
...
// // box2dMovement.getRandomWaypointIndex(currentTargetIndex);
	...
	/*
	 * Hier geschieht die Magie: Nach komplexen Formeln dreht das Enemy sich in die Richtung der angegebenen Position und bewegt
	 * sich auf diese zu.
	 */
